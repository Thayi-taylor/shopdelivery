    	...
    	<div class="d-flex justify-content-center mt-5">
    		<form method="post" action="${contextPath }/Driver/registerDriverPro.do">
    			...
    			<div class="input-group mt-3">
    				<input type="text" class="form-control" value="driver3" id="driverID" name="driverID" oninput="validateDriverID(event)">
    				<div id="msg-driverID"></div>
    			</div>
    			<label class="mt-3">비밀번호</label>
    			<div class="input-group mt-3">
    				<input type="password" class="form-control" value="Driver333!!!!" id="driverPW" name="driverPW" oninput="validateDriverPW(event)">
    				<div id="msg-driverPW"></div>
    			</div>
    			<label class="mt-3">이름</label>
    			<div class="input-group mt-3">
    				<input type="text" class="form-control" value="기사랍니다" id="driverName" name="driverName" oninput="validateDriverName(event)">
    				<div id="msg-driverName"></div>
    			</div>
    			<label class="mt-3">휴대폰</label>
    			<div class="input-group mt-3">
    				<input type="text" class="form-control" value="010" id="driverMobile1" name="driverMobile1" oninput="validateDriverMobile(event)">
    				-
    				<input type="text" class="form-control" value="1234" id="driverMobile2" name="driverMobile2" oninput="validateDriverMobile(event)">
    				-
    				<input type="text" class="form-control" value="1234" id="driverMobile3" name="driverMobile3" oninput="validateDriverMobile(event)">
    				<div id="msg-driverMobile"></div>
    			</div>
    			<label class="mt-3">배달가능지역</label>
    			<div class="input-group mt-3">
    				<input type="text" class="form-control" value="강남" id="driverAvailableArea" name="driverAvailableArea" oninput="validateDriverAvailableArea(event)">
